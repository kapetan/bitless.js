...
Client.prototype.toString = function(encoding) {
	...
	var version = this.version.join('.') + (this.version.length <= 1 ? '.0' : '');
...
Client.prototype.equals = function(obj) {
	...
	return utils.buffer.equals(this.pack(), obj.pack());
};
...
exports.generate = function(id, version, encoding) {
	...
	version = version === undefined ? DEFAULT_VERSION : version;
	id = id || DEFAULT_ID;
	...
	return new client((client.IDS && client.IDS[id]), id, version);
};
